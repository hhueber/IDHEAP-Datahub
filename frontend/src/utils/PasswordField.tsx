...
export default function PasswordField({
    ...
    const baseInput =
        "block w-full rounded border px-3 pr-12 py-2 text-sm leading-5 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500";
    const variantInput = variant === "minimal" ? "rounded" : "rounded-lg";
    const spacing = hideLabel ? "" : "mt-1";
    const inputClass = className
        ? className
        : [baseInput, variantInput, spacing].join(" ").trim();
    ...
    return (
        <div>
            ...
            <label
                className={
                    hideLabel ? "sr-only" : "block text-sm font-medium mb-1"
                }
                htmlFor={id}
            >
                {label}
                    ...
                    >
                        {visible ? (
                            ...
                            >
                                ...
                                />
                                <path
                                    d="M10.58 10.58A3 3 0 0 0 12 15a3 3 0 0 0 3-3 3 3 0 0 0-4.42-2.42"
                                    stroke="currentColor"
                                    strokeWidth="2"
                                    fill="none"
                                />
                                <path
                                    d="M2 12s3.5-7 10-7 10 7 10 7a17.3 17.3 0 0 1-3.22 3.82M6.12 6.12A17.3 17.3 0 0 0 2 12"
                                    stroke="currentColor"
                                    strokeWidth="2"
                                    fill="none"
                                />

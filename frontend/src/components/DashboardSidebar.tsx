...
function ItemLink({ to, children }: { to: string; children: React.ReactNode }) {
    const { primary, textColor, adaptiveTextColorPrimary, hoverPrimary06 } =
        useTheme();
    return (
        <NavLink
            to={to}
...
function TreeItem({
    ...
    const activeChild =
        ...
        item.children!.some((c) =>
            c.to
                ? isPathActive(c.to, currentPath)
                : c.children?.some(
                      (gc) => gc.to && isPathActive(gc.to, currentPath),
                  ),
        );
        ...
        <div className="select-none">
                ...
                style={
                    {
                        ...
                        "--sidebar-section-active-text":
                            adaptiveTextColorPrimary,
                    } as React.CSSProperties
                }
                aria-expanded={isOpen(item.key)}
                aria-label={t("dashboardSidebar.toggleSection", {
                    section: label,
                })}
            >
            ...
            {isOpen(item.key) && hasChildren && (
                <div className="mt-1 space-y-1">
                    {item
                        .children!.filter((c) => canSee(userRole, c))
                        .map((child) => (
                            <TreeItem
                                key={child.key}
                                item={child}
...
export default function DashboardSidebar() {
    ...
    const menu: MenuItem[] = [
        {
            key: "dashboard",
            labelKey: "dashboardSidebar.sections.dashboard",
            to: "/dashboard",
            roles: ["ADMIN", "MEMBER"],
        },
        {
            ...
            children: [
                {
                    key: "survey-all",
                    labelKey: "dashboardSidebar.survey.all",
                    to: "/admin/surveys",
                    roles: ["ADMIN", "MEMBER"],
                },
                {
                    key: "survey-edit",
                    labelKey: "dashboardSidebar.survey.newEdit",
            ...
            children: [
                {
                    ...
                    children: [
                        {
                            key: "qps-all",
                            labelKey: "dashboardSidebar.qa.qps.all",
                            to: "/admin/qps",
                            roles: ["ADMIN", "MEMBER"],
                        },
                        {
                            key: "qps-edit",
                            labelKey: "dashboardSidebar.qa.qps.newEdit",
                            to: "/admin/qps/new",
                            roles: ["ADMIN", "MEMBER"],
                        },
                    ],
                },
                {
                    ...
                    children: [
                        {
                            key: "qglobal-all",
                            labelKey: "dashboardSidebar.qa.qglobal.all",
                            to: "/admin/qglobal",
                            roles: ["ADMIN", "MEMBER"],
                        },
                        {
                            key: "qglobal-edit",
                            labelKey: "dashboardSidebar.qa.qglobal.newEdit",
                            to: "/admin/qglobal/new",
                            roles: ["ADMIN", "MEMBER"],
                        },
                    ],
                },
                {
                    ...
                    children: [
                        {
                            key: "qcat-all",
                            labelKey: "dashboardSidebar.qa.qcat.all",
                            to: "/admin/qcat",
                            roles: ["ADMIN", "MEMBER"],
                        },
                        {
                            key: "qcat-edit",
                            labelKey: "dashboardSidebar.qa.qcat.newEdit",
                            to: "/admin/qcat/new",
                            roles: ["ADMIN", "MEMBER"],
                        },
                    ],
                },
                {
                    ...
                    children: [
                        {
                            key: "answer-all",
                            labelKey: "dashboardSidebar.qa.answer.all",
                            to: "/admin/answers",
                            roles: ["ADMIN", "MEMBER"],
                        },
                        {
                            key: "answer-edit",
                            labelKey: "dashboardSidebar.qa.answer.newEdit",
                ...
                },
                {
                    ...
                    children: [
                        {
                            key: "option-all",
                            labelKey: "dashboardSidebar.qa.option.all",
                            to: "/admin/options",
                            roles: ["ADMIN", "MEMBER"],
                        },
                        {
                            key: "option-edit",
                            labelKey: "dashboardSidebar.qa.option.newEdit",
                            to: "/admin/options/new",
                            roles: ["ADMIN", "MEMBER"],
                        },
                    ],
                },
            ...
            children: [
                {
                    ...
                    children: [
                        {
                            key: "commune-all",
                            labelKey: "dashboardSidebar.places.commune.all",
                ...
                },
                {
                    ...
                    children: [
                        {
                            key: "district-all",
                            labelKey: "dashboardSidebar.places.district.all",
                            to: "/admin/places/districts",
                            roles: ["ADMIN", "MEMBER"],
                        },
                    ],
                },
                {
                    ...
                    children: [
                        {
                            key: "canton-all",
                            labelKey: "dashboardSidebar.places.canton.all",
                            to: "/admin/places/cantons",
                            roles: ["ADMIN", "MEMBER"],
                        },
                    ],
                },
        ...
        },
        {
            ...
            children: [
                {
                    key: "admin-password",
                    labelKey: "dashboardSidebar.administration.changePassword",
                    ...
                    children: [
                        {
                            key: "admin-users-new",
                            labelKey:
                                "dashboardSidebar.administration.users.add",
                            to: "/admin/users/new",
                            roles: ["ADMIN"],
                        },
                        {
                            key: "admin-users-del",
                            labelKey:
                                "dashboardSidebar.administration.users.delete",
                ...
                },
                {
                    ...
                    children: [
                        {
                            key: "admin-config-placeOfInterest",
                            labelKey:
                                "dashboardSidebar.administration.config.placeOfInterest",
                            to: "/admin/config/placeOfInterest",
                            roles: ["ADMIN"],
                        },
                        {
                            key: "admin-config-theme",
                            labelKey:
                                "dashboardSidebar.administration.config.theme",
    ...
    React.useEffect(() => {
        ...
        const visit = (items: MenuItem[], parents: string[]) => {
            for (const it of items) {
                const active = it.to
                    ? isPathActive(it.to, location.pathname)
                    : false;
    ...
    const roleLabel = /roles\./.test(roleKey)
        ? roleKey && roleKey !== "roles."
            ? (t as any)(roleKey) !== roleKey
                ? t(roleKey)
                : user?.role || ""
            : ""
        : "";
    ...
    return (
        <aside
            className="fixed left-0 top-16 w-64 border-r"
            style={{

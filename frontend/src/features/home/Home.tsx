...
export default function Home() {
    ...
    const lang = normalizeGeoLanguage(i18n.resolvedLanguage ?? i18n.language);
    ...
    const [selectedQuestionUid, setSelectedQuestionUid] = useState<
        number | null
    >(null);
    ...
    return (
        ...
        */}
          ...
          "
                    ...
                    aria-label={
                        panelOpen ? t("home.close") : t("home.openPanel")
                    }
                >
                    <svg
                        viewBox="0 0 24 24"

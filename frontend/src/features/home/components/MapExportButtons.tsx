        ...
        >
            ...
            <div className="flex flex-wrap gap-2">
                ...
                >
                    ...
                    >
                        <path
                            d="M4 5a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V5Z"
                            fill="currentColor"
                        />
                        <path
                            d="M8 15l3-3 2 3 3-3 2 3v2H8v-2Z"
                            fill="white"
                            opacity=".6"
                        />
                    </svg>
            ...
            <div className="sr-only" aria-live="polite">
                {busy === "png"
                    ? t("export.ariaExportPng")
                    : busy === "pdf"
                      ? t("export.ariaExportPdf")
                      : ""}
            </div>
        </section>
    );

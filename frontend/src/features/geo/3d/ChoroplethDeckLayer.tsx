...
export default function ChoroplethDeckLayer({
    ...
    useEffect(() => {
        granularityRef.current = choropleth.granularity;
    ...
    useEffect(() => {
        labelLookupRef.current = labelLookup;
    }, [labelLookup]);
    ...
    const layer = useMemo(() => {
        ...
        return new GeoJsonLayer({
            ...
            pickable: true,
            autoHighlight: true,
            highlightColor: [255, 255, 255, 50] as [
                number,
                number,
                number,
                number,
    ...
    useEffect(() => {
        ...
        const deck = new Deck({
            ...
            onHover: (info: any) => {
                ...
                el.style.transform = `translate(${info.x + 14}px, ${
                    info.y - 10
                }px)`;

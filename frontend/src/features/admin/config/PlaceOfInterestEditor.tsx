...
export default function PlaceOfInterestEditor({
    ...
    return (
        <ConfigEditorModal
            title={
                initial
                    ? t("admin.config.placeOfInterestEditor.titleEdit")
                    : t("admin.config.placeOfInterestEditor.titleCreate")
            }
            isSaving={saving}
            onClose={onClose}
            onSubmit={onSubmit}
            submitLabel={
                initial
                    ? t("admin.config.placeOfInterestEditor.submitEdit")
                    : t("admin.config.placeOfInterestEditor.submitCreate")
            }
        >
            ...
            >
                <div className="font-medium mb-2" style={{ color: textColor }}>
                    {t("admin.config.placeOfInterestEditor.importFromCommunes")}
                </div>
                <AutocompleteField<GeoSuggestion>
                    ...
                    debounceMs={250}
                    placeholder={t(
                        "admin.config.placeOfInterestEditor.searchPlaceholder",
                    )}
                    fetchItems={async (q) => {
                    ...
                    renderLoading={() => (
                        <LoadingDots
                            label={t(
                                "admin.config.placeOfInterestEditor.search",
                            )}
                        />
                    )}
                    renderEmpty={(q) =>
            ...
            <div>
                <label className="block text-sm font-medium mb-1">
                    {t("admin.config.placeOfInterestEditor.canonicalLabel")}
                </label>
                <input
                    name="default_name"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label className="block text-sm font-medium mb-1">
                        {t("admin.config.placeOfInterestEditor.labels.fr")}
                    </label>
                    <input
                        name="name_fr"
                        value={form.name_fr || ""}
                ...
                <div>
                    <label className="block text-sm font-medium mb-1">
                        {t("admin.config.placeOfInterestEditor.labels.de")}
                    </label>
                    <input
                        name="name_de"
                        value={form.name_de || ""}
                ...
                <div>
                    <label className="block text-sm font-medium mb-1">
                        {t("admin.config.placeOfInterestEditor.labels.it")}
                    </label>
                    <input
                        name="name_it"
                        value={form.name_it || ""}
                ...
                <div>
                    <label className="block text-sm font-medium mb-1">
                        {t("admin.config.placeOfInterestEditor.labels.rm")}
                    </label>
                    <input
                        name="name_rm"
                        value={form.name_rm || ""}
                ...
                <div>
                    <label className="block text-sm font-medium mb-1">
                        {t("admin.config.placeOfInterestEditor.labels.en")}
                    </label>
                    <input
                        name="name_en"
                        value={form.name_en || ""}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    <label className="block text-sm font-medium mb-1">
                        {t("admin.config.placeOfInterestEditor.labels.lat")}
                    </label>
                    <input
                        type="number"
                        step="0.0001"
                    ...
                    >
                        {t("admin.config.placeOfInterestEditor.labels.preview")}{" "}
                        {fmt4(form.pos[0])}
                    </div>
                </div>
                <div>
                    <label className="block text-sm font-medium mb-1">
                        {t("admin.config.placeOfInterestEditor.labels.lon")}
                    </label>
                    <input
                        type="number"
                        step="0.0001"

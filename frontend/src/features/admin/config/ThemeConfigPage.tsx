...
import {
    PresetsSection,
    Preset,
} from "@/features/admin/components/theme/PresetsSection";
...
export default function ThemeConfigPage() {
    ...
    const [pendingLogoFileInfo, setPendingLogoFileInfo] =
        useState<PendingLogoFileInfo | null>(null);
    ...
    function validateLogoFile(file: File): string | null {
        ...
        if (file.size > maxBytes) {
            return t("admin.config.themeConfigPage.logoTooLarge", {
                size: MAX_LOGO_MB,
            });
        }
        return null;
        ...
        >
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center gap-2">
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                updateField("instance_name", e.target.value)
                            }
                        />
                    </div>
                        ...
                        <div className="grid grid-cols-1 gap-4 lg:grid-cols-[220px_minmax(0,1fr)]">
                            ...
                            >
                                <div className="mb-3 text-sm font-medium opacity-70">
                                    {t(
                                        "admin.config.themeConfigPage.logoPreview",
                                    )}
                                </div>
                                ...
                                >
                                    {previewUrl ? (
                                        ...
                                        <span className="text-xs opacity-50">
                                            {t(
                                                "admin.config.themeConfigPage.noLogo",
                                            )}
                                        </span>
                                    )}
                                </div>
                                ...
                                {pendingLogoFileInfo ? (
                                    ...
                                    <div className="mt-4 text-[11px] opacity-60 text-center">
                                        {t(
                                            "admin.config.themeConfigPage.logoFormats",
                                            { size: MAX_LOGO_MB },
                                        )}
                                    </div>
                                )}
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    <label className="text-sm font-medium opacity-80">
                                        {t(
                                            "admin.config.themeConfigPage.logoUrl",
                                        )}
                                    </label>
                                    <input
                                        type="text"
                                ...
                                <div className="space-y-2">
                                    <label className="text-sm font-medium opacity-80">
                                        {t(
                                            "admin.config.themeConfigPage.logoUpload",
                                        )}
                                    </label>
                                    ...
                                    <div
                                        ...
                                        tabIndex={0}
                                        aria-label={t(
                                            "admin.config.themeConfigPage.logoDropZone",
                                        )}
                                    >
                                        {isDragActive && (
                                            <div
                                            ...
                                            >
                                                ...
                                                >
                                                    {isDragReject
                                                        ? t(
                                                              "admin.config.themeConfigPage.logoDropReject",
                                                          )
                                                        : t(
                                                              "admin.config.themeConfigPage.logoDropActive",
                                                          )}
                                                </div>
                                            </div>
                                        )}
                                        ...
                                        >
                                            ...
                                            <p className="mt-1 text-xs opacity-60">
                                                {t(
                                                    "admin.config.themeConfigPage.logoDropHint",
                                                )}
                                            </p>
                                            ...
                                            <div className="mt-4 flex flex-wrap items-center justify-center gap-2">
                                                ...
                                                >
                                                    {t(
                                                        "admin.config.themeConfigPage.logoBrowse",
                                                    )}
                                                </button>
                    ...
                    <div className="flex flex-col md:flex-row md:items-center gap-2">
                        ...
                        <div className="flex items-center gap-4">
                            <label className="inline-flex items-center gap-1 text-sm">
                                ...
                                />
                                <span>
                                    {t("admin.config.themeConfigPage.light")}
                                </span>
                            </label>
                            <label className="inline-flex items-center gap-1 text-sm">
                                <input
                                ...
                                />
                                <span>
                                    {t("admin.config.themeConfigPage.dark")}
                                </span>
                            </label>
                        </div>
                    </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-end gap-3">
                ...
                >
                    {saveState === "saving" ? (
                        <LoadingDots
                            label={t("admin.config.themeConfigPage.saving")}
                        />
                    ) : (

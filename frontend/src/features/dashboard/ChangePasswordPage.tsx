...
export default function ChangePasswordPage() {
    ...
    const validate = () => {
        ...
        if (form.new_password !== form.confirm) {
            setErrKey("changePassword.errors.confirmMismatch");
            return false;
        }
        // erreur car mot de passe trop court
        if (form.new_password.length < 10) {
            setErrKey("changePassword.errors.tooShort");
            return false;
        }
        return true;
    };
    ...
    const onSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (r.success) {
                setMsgKey(
                    r.detail
                        ? "changePassword.successWithDetail"
    ...
    return (
        ...
        >
          ...
          "
                ...
                >
                    {submitting ? (
                        <LoadingDots label={t("changePassword.submitting")} />
                    ) : (

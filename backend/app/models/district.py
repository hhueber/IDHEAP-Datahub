...
class District(Base):
    ...
    district_map_uid: Mapped[int] = mapped_column(ForeignKey("district_map.uid", ondelete="CASCADE"), nullable=True)
    district_map: Mapped[List["DistrictMap"]] = relationship("DistrictMap", back_populates="district")
